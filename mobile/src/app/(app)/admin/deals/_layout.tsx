...
/**
 * Stack for the deals section of the console.
 *
 * Exists so the section is one route to the tab bar above: without it the tab
 * navigator would list every file here separately (`deals/index`, `deals/[id]`),
 ...
 */
export default function DealsSectionLayout() {
