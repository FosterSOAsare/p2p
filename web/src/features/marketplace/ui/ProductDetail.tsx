              ...
              <div className="space-y-3">
                ...
                {(!me || (me.role !== 'admin' && me.kycStatus !== 'verified')) ? (
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      onClick={() => navigate(me ? `/messages/${product.seller.username}?redirect=/marketplace/${product.id}` : '/login')}
                  ...
                  <button
                    onClick={() => navigate(`/messages/${product.seller.username}?redirect=/marketplace/${product.id}`)}
