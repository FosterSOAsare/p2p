/**
 * Fee quote preview — a mirror of `server/src/features/escrows/money.ts`.
 * Keep the two in sync: the server recomputes and stores the real numbers at
 * creation, this only pre-fills what the form shows.
 *
